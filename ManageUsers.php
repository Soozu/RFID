...
<main>
	<h1 class="slideInDown animated">Add a new User, update information <br> or remove</h1>
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			...
			<fieldset>
				...
				<input type="text" name="number" id="number" placeholder="Student Number/LRN...">
				<input type="email" name="email" id="email" placeholder="Parents Email...">
			</fieldset>
			<fieldset>
